...
image:https://codecov.io/gh/gesinn-it-pub/mediawiki-extensions-Mpdf/branch/master/graph/badge.svg?token=dihJ4cJWer[Codecov,link=https://app.codecov.io/gh/gesinn-it-pub/mediawiki-extensions-Mpdf]
